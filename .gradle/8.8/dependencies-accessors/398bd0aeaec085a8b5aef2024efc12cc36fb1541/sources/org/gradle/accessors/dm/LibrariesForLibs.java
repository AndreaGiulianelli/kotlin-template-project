...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotestAssertionsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>kotest.assertions.core</b>
         */
        public KotestAssertionsCoreLibraryAccessors getCore() {
            return laccForKotestAssertionsCoreLibraryAccessors;
        }
    ...
    public static class KotestAssertionsCoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>jvm</b> with <b>io.kotest:kotest-assertions-core-jvm</b> coordinates and
         * with version reference <b>kotest</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJvm() {
            return create("kotest.assertions.core.jvm");
        }
    ...
    public static class KotlinBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>kotlin.testing</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getTesting() {
            return createBundle("kotlin.testing");
        }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>kotlin.qa</b> with plugin id <b>org.danilopianini.gradle-kotlin-qa</b> and
         * with version <b>0.62.3</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getQa() { return createPlugin("kotlin.qa"); }
